    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="nav-item float-end d-flex align-items-center">
            <p class=" me-2 text-light" style="letter-spacing: 1px">{{ Auth::user()->name }} <a href="" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
